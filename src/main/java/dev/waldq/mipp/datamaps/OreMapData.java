...
public record OreMapData(int hexColor, Optional<ResourceLocation> mainBlock) {
    public static final Codec<OreMapData> CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            ResourceLocation.CODEC.optionalFieldOf("mainBlock").forGetter(OreMapData::mainBlock)
